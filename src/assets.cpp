...
namespace assets {
    struct {
        ...
        zf::t_static_array<zf::rendering::t_resource *, ecm_texture_id_cnt> textures;

        zf::t_static_array<zf::rendering::t_font, ecm_font_id_cnt> fonts;
    } g_module_state;
    ...
    void load_all(zf::mem::t_arena *const arena, zf::mem::t_arena *const temp_arena) {
        ...
        for (zf::t_i32 i = 0; i < ecm_texture_id_cnt; i++) {
        ...
        for (zf::t_i32 i = 0; i < ecm_font_id_cnt; i++) {
