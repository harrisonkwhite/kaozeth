...
namespace world {
    ...
    void render(const t_world *const world, zgl::gfx::t_frame_context *const frame_context, zf::mem::t_arena *const temp_arena) {
        ...
        zgl::gfx::frame_pass_begin_offscreen(frame_context, world->texture_target_all, zf::math::matrix_create_identity(), true, k_bg_color);
        ...
        zgl::gfx::frame_pass_begin(frame_context, zgl::platform::window_get_framebuffer_size_cache(), cam_view_mat, true);
